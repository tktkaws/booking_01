  ...
  return (
    ...
    >
      <div className="flex max-h-[80vh] flex-col">
        ...
        <div className="overflow-y-auto px-6 py-6 text-sm text-slate-800">
          <dl className="grid grid-cols-[120px_1fr] gap-x-4 gap-y-3">
            <dt className="px-4 text-sm font-semibold text-slate-800">日時</dt>
            <dd className="px-4 font-medium text-slate-800">{scheduleLabel}</dd>

            <dt className="px-4 text-sm font-semibold text-slate-800">部署</dt>
            <dd className="px-4">
              <span
            ...
            <dt className="px-4 text-sm font-semibold text-slate-800">担当者</dt>
            <dd className="px-4 font-medium text-slate-800">{booking.ownerName}</dd>

            <dt className="px-4 text-sm font-semibold text-slate-800">タイトル</dt>
            <dd className="px-4 font-medium text-slate-800">{booking.title}</dd>

            {booking.description && (
              <>
                <dt className="px-4 text-sm font-semibold text-slate-800">メモ</dt>
          ...
          {canEdit ? (
            <>
              <button
                ...
                className="rounded-md border border-red-200 px-4 h-9 grid items-center text-sm font-semibold text-red-600 transition hover:border-red-300 hover:bg-red-50"
              >
                削除
              </button>
              <button
